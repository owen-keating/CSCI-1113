...
//  hw7A
//
//  Created by Owen Keating on 4/1/21.
//
...
public:
    creature();
    creature(string n, int h, int d, bool c);
    string getName();
...
int main()
{
    ...
    creature heroine = creature(hname, 10, 1, false);
...
void gotoTown(creature& you)
{
    ...
    cout << you.getName() << " walks into town, do you want to buy a (c)anoe or e(x)it town?\n";
    string c;
    getline(cin, c);
    if(c=="c")
    {
        cout << "You are now the proud owner of your very own floatation device!\n";
        you.setCanoe(true);
    }
    cout << "You exit town while whistling a jolly tune.\n";
...
creature::creature(string n, int h, int d, bool c)
{
    name = n;
    hp = h;
    dmg = d;
...
bool creature::getCanoe()
{
    return canoe;
}

void creature::setCanoe(bool c)
{
    canoe = c;
}
